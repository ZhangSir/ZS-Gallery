...
import com.itzs.zsgallery.imageloader.IoUtils;
...
public class BaseImageDecoder implements ImageDecoder {
	...
	/**
	 * Decodes image from URI into {@link Bitmap}. Image is scaled close to incoming target size
...
//
	protected Options prepareDecodingOptions(int[] imageSize, int[] targetSize) {
		...
		int	scale = computeImageSampleSize(imageSize[0], imageSize[1], targetSize[0], targetSize[1], false, false);
