...
public class ImageViewAware extends ViewAware {
	 ...
	 */
	public ImageViewAware(ImageView imageView, boolean shouldCompress) {
		super(imageView, shouldCompress);
	}
	 ...
	 *@param shouldCompress Bitmap should be compress before display
	 */
	public ImageViewAware(ImageView imageView, boolean checkActualViewSize, boolean shouldCompress) {
		super(imageView, checkActualViewSize, shouldCompress);
	}
